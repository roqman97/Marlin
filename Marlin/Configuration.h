...
#define MPCTEMP        // ** EXPERIMENTAL ** // TR
 ...
 */
#if ENABLED(MPCTEMP)
  #define MPC_EDIT_MENU                             // Add MPC editing to the "Advanced Settings" menu. (~1300 bytes of flash) // TR
  #define MPC_AUTOTUNE_MENU                         // Add MPC auto-tuning to the "Advanced Settings" menu. (~350 bytes of flash) // TR
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 137 } // TR
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 5, 25 } // TR
...
#define USE_PROBE_FOR_Z_HOMING // TR
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44.2, -10, -1.68 } // TR

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 25 // TR
...
#define Z_HOMING_HEIGHT  10 // TR     // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
                                  // Be sure to have this much clearance over your Z_MAX_POS to prevent grinding.

#define Z_AFTER_HOMING  10      // TR (mm) Height to move to after homing Z
...
#define X_BED_SIZE 400 // TR
#define Y_BED_SIZE 400 // TR
 ...
 */
#define FILAMENT_RUNOUT_SENSOR // TR
#if ENABLED(FILAMENT_RUNOUT_SENSOR)
  #define FIL_RUNOUT_ENABLED_DEFAULT true // Enable the sensor on startup. Override with M412 followed by M500.
  #define NUM_RUNOUT_SENSORS   1          // Number of sensors, up to one per extruder. Define a FIL_RUNOUT#_PIN for each.

  #define FIL_RUNOUT_STATE     HIGH // TR        // Pin state indicating that filament is NOT present.
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 7 // TR
...
#define AUTO_BED_LEVELING_BILINEAR // TR
//#define AUTO_BED_LEVELING_UBL
//#define MESH_BED_LEVELING // TR
 ...
 */
#define PREHEAT_BEFORE_LEVELING  // TR
#if ENABLED(PREHEAT_BEFORE_LEVELING)
  #define LEVELING_NOZZLE_TEMP 180   // (°C) Only applies to E0 at this time // TR
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define PROBE_Y_FIRST
    ...
    #define EXTRAPOLATE_BEYOND_GRID // TR
  ...
  #define GRID_MAX_POINTS_X 4 // TR      // Don't use more than 15 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
...
#define PREHEAT_1_TEMP_HOTEND 200 // TR
#define PREHEAT_1_TEMP_BED     60 // TR
#define PREHEAT_1_TEMP_CHAMBER 35
#define PREHEAT_1_FAN_SPEED   255 // Value from 0 to 255

#define PREHEAT_2_LABEL       "PETG" // TR
#define PREHEAT_2_TEMP_HOTEND 240
#define PREHEAT_2_TEMP_BED    70 // TR
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU // TR
